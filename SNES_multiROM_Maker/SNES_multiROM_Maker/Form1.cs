...
namespace SNES_multiROM_Maker
{
    public partial class SNESmulticartMaker : Form
    {
        ...
        {
            InitializeComponent();
            pictureBox1.Image = SNES_multiROM_Maker.Properties.Resources.smalllogo2;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                //multigame = new byte[(snes1.Length + snes2.Length == 4194304) ? snes1.Length + snes2.Length + 512 : 
                //    (snes1.Length + snes2.Length == 4194304*2) ? snes1.Length + snes2.Length + 512 : (4194304 * 2 + 512)];

                if (snes1.Length < 4194304 && snes2.Length < 4194304)
                {
                    gamesAvailable = 0x22;
                    is4mb = 0;
                    multigame = new byte[4194304];
                }
                else
                {
                    gamesAvailable = 0x42;
                    is4mb = 1;
                    multigame = new byte[4194304*2];
                }
        ...
        {
            string line1 = "                        --SNES Multi-Cart Maker--";
            string line2 = "                      Version 0.01, December 3 2021";
